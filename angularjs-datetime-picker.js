(function () {
    ...
    var tmpl = [
        ...
        '    <label class="secondssLabel">Sec:</label> <input class="secondsInput" type="range" min="0" max="59" ng-model="inputSecond"  ng-change="updateNgModel()"/> ',
        '  </div> ',
        '</div>'].join("\n");
    ...
    var datetimePickerPopup = function ($locale, dateFilter) {
        ...
        var linkFunc = function (scope, element, attrs, ctrl) { //jshint ignore:line
            ...
            var dateFormat = attrs.dateFormat;// || moment.ISO_8601;
            scope.months = months;
